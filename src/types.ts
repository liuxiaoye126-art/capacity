...
export const CUSTOMERS = ['上海农商银行', '兴业银行', '浦发银行', '中信银行', '中国银行', '上海银行'];
...
export const LEVEL3_DATA: CapacityRecord[] = [
  {
    ...
    period: '2026Q1（1-3月）',
    customer: '兴业银行',
    contract: '兴业银行2026年度客户经营平台技术服务合同',
    position: '高级',
    project: '客户经营标签链路优化',
    operationCenter: '上海运营中心',
    subCenter: '信用卡分中心',
  ...
  },
  {
    ...
    period: '2026Q1（1-3月）',
    customer: '上海农商银行',
    contract: '上海农商银行2023-2026年度信贷及信用卡领域战略技术服务合同',
    position: '高级',
    project: '专项分期电子签名功能优化',
    operationCenter: '上海运营中心',
    subCenter: '信用卡分中心',
...
export const LEVEL4_DATA: CapacityRecord[] = [
  {
    ...
    relatedLevelThreeIds: ['L3-2026Q1-001'],
  },
  {
    id: 'L4-2026Q1-002',
    period: '2026Q1（1-3月）',
  ...
  },
  {
    ...
    relatedLevelThreeIds: ['L3-2026Q1-004'],
  },
  {
    id: 'L4-2026Q1-005',
    period: '2026Q1（1-3月）',
  ...
  },
  {
    ...
    relatedLevelThreeIds: ['L3-2026Q1-013'],
  },
  {
    id: 'L4-2026Q1-008',
    period: '2026Q1（1-3月）',
  ...
  },
  {
    ...
    workDays: 412,
    handler: '李晓燕',
    updatedAt: '2026-04-15 10:18',
    relatedLevelThreeIds: ['L3-2026Q1-016'],
  },
  {
    id: 'L4-2026Q1-010',
    period: '2026Q1（1-3月）',
...
export const LEVEL5_DATA: CapacityRecord[] = [
  ...
  },
  {
    ...
    workDays: 412,
    handler: '陈敏',
    updatedAt: '2026-04-18 10:22',
    relatedLevelFourId: 'L4-2026Q1-010',
  },
];